...
namespace BinarySerializer
{
    ...
    public class BinarySerializer
    {
        ...
        [Binary(typeof(BinaryList32<BinaryString16>))]
        public List<string> l2 { get; set; }

        [Binary(typeof(BinaryList32<BinaryInt32>))]
        public List<int> l3 { get; set; }

        [Binary(typeof(BinaryDictionary16<BinaryInt32, BinaryInt32>))]
        public Dictionary<int, int> d1 { get; set; }

        [Binary(typeof(BinaryDictionary16<BinaryInt32, InputClass>))]
        public Dictionary<int, InputClass> d2 { get; set; }

        [Binary(typeof(BinaryArray16<BinaryInt32>))]
