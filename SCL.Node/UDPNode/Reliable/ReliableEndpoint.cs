...
{
	/// <summary>
	/// Quality-of-service тип сообщения
	/// </summary>
	public enum QosType : byte
	{
		/// <summary>
		/// Канал с гарантированой доставкой в порядке очереди с гарантией доставки
		/// </summary>
		Reliable = 0,

		/// <summary>
		/// Канал без гарантированой доставки в случайном порядке
		/// </summary>
		Unreliable = 1,

		/// <summary>
		/// Канал без гарантированой доставки в порядке очереди
		/// </summary>
		UnreliableOrdered = 2
	}
