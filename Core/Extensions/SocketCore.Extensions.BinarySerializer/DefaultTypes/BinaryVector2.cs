...
//        {
//            return (ms, s, val) => new Vector2(((InputPacketBuffer)ms).ReadFloat(), ((InputPacketBuffer)ms).ReadFloat());
//        }

//        public override BinaryWriteAction GetWriteAction(string scheme = "default", PropertyInfo property = null)
//        {
//            dynamic func = Extensions.CreateGetPropertyFuncDynamic<Vector2>(property);
